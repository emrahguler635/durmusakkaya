...
// Old code removed - keeping for reference
function OldNewsDetailPage({ params }: { params: { slug: string } }) {
  const oldNews = staticNews.find(n => n.slug === params.slug && n.published);
